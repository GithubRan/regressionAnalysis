...
f.X=1-6*X+X^2+X^3  ## the values of the true regression function on the design points.
...
sigma.e=10 ## error standard deviation
...
par(mfrow=c(3,3), mar = c(0,0,0,0)) ## create a plot with 3 by 3 panels
for (k in 1:9){
...
l.order=c(1,2,3,5,8, 11) ## order of the polynomial models to be fitted
